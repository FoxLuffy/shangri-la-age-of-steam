...
APPEARANCES = {
    "industrial": [
        ...
        "wearing heavy leather overalls and welding goggles",
        "missing a finger, replaced with a brass digit",
        "smelling of sulfur and sweat",
    ],
    "alchemical": [
        "wearing a stained apron smelling of ozone",
        "sporting thick magnifying spectacles",
        "with fingertips stained purple from reagents",
        "carrying a bandolier of glowing vials",
    ],
    "high_society": [
        "wearing a pristine silk cravat",
        "holding a silver-tipped walking cane",
        "wearing an elaborate monocle with multiple lenses",
        "dressed in a velvet coat with brass buttons",
    ],
}
...
def generate_procedural_npc(session: Session, location_flavor: str = "industrial") -> NPC:
    ...
    npc = NPC(id=npc_id, name=full_name, traits=traits, disposition=0.0)
